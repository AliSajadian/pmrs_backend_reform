...
urlpatterns = [
    ...
    path('api/financialInfos/contractMonthReportList/<int:contractid>/<int:dateid>/', 
         FinancialInfoAPI.as_view({"get": "contract_month_report_list"}), name='contractMonthReportList'),    
    path('api/financialInfos/contractMonthFCReportList/<int:contractid>/<int:dateid>/', 
         FinancialInfoAPI.as_view({"get": "contract_month_fc_report_list"}), name='contractMonthFCReportList'),   

    path('api/hses/contractMonthReportList/<int:contractid>/<int:dateid>/', 
         HseAPI.as_view({"get": "contract_month_report_list"}), name='contractMonthReportList'),
    path('api/progressStates/contractMonthReportList/<int:contractid>/<int:dateid>/', 
         ProgressStateAPI.as_view({"get": "contract_month_report_list"}), name='contractMonthReportList'),

    path('api/invoices/contractMonthReportList1/<int:contractid>/<int:dateid>/', 
         InvoiceAPI.as_view({"get": "contract_month_report_list1"}), name='contractMonthReportList1'),
    path('api/invoices/contractMonthFCReportList1/<int:contractid>/<int:dateid>/', 
         InvoiceAPI.as_view({"get": "contract_month_fc_report_list1"}), name='contractMonthFCReportList1'),

    path('api/invoices/contractMonthReportList2/<int:contractid>/<int:dateid>/', 
         InvoiceAPI.as_view({"get": "contract_month_report_list2"}), name='contractMonthReportList2'),
    path('api/invoices/contractMonthFCReportList2/<int:contractid>/<int:dateid>/', 
         InvoiceAPI.as_view({"get": "contract_month_fc_report_list2"}), name='contractMonthFCReportList2'),

    path('api/financialInvoices/contractMonthReportList1/<int:contractid>/<int:dateid>/', 
         FinancialInvoiceAPI.as_view({"get": "contract_month_report_list1"}), name='contractMonthReportList1'),
    path('api/financialInvoices/contractMonthFCReportList1/<int:contractid>/<int:dateid>/', 
         FinancialInvoiceAPI.as_view({"get": "contract_month_fc_report_list1"}), name='contractMonthFCReportList1'),

    path('api/financialInvoices/contractMonthReportList2/<int:contractid>/<int:dateid>/', 
         FinancialInvoiceAPI.as_view({"get": "contract_month_report_list2"}), name='contractMonthReportList2'),
    path('api/financialInvoices/contractMonthFCReportList2/<int:contractid>/<int:dateid>/', 
         FinancialInvoiceAPI.as_view({"get": "contract_month_fc_report_list2"}), name='contractMonthFCReportList2'),

    path('api/pmsProgresses/contractMonthReportList/<int:contractid>/<int:dateid>/', 
         PmsprogressAPI.as_view({"get": "contractMonthReportList"})),
    path('api/budgetCosts/contractMonthReportList/<int:contractid>/<int:dateid>/', 
         BudgetCostAPI.as_view({"get": "contractMonthReportList"})),
    path('api/workVolumes/contractMonthReportList/<int:contractid>/<int:dateid>/', 
         WorkVolumeAPI.as_view({"get": "contractMonthReportList"})),
    path('api/machineries/contractMonthReportList/<int:contractid>/<int:dateid>/', 
         MachineryAPI.as_view({"get": "contractMonthReportList"})),
    path('api/projectPersonals/contractMonthReportList/<int:contractid>/<int:dateid>/', 
         ProjectPersonalAPI.as_view({"get": "contractMonthReportList"})),
    path('api/problems/contractMonthReportList/<int:contractid>/<int:dateid>/', 
         ProblemAPI.as_view({"get": "contractMonthReportList"})),
    path('api/criticalActions/contractMonthReportList/<int:contractid>/<int:dateid>/', 
         CriticalActionAPI.as_view({"get": "contractMonthReportList"})),
]
