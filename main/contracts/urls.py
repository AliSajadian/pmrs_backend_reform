...
from .api import ContractTypeAPI, CurrencyAPI, CountryAPI, ContractAddendumAPI, PersonelTypeAPI, \
    PersonelAPI, ContractAPIEx, get_contract_base_info, put_start_operation_date, put_contract_base_info, \
        put_notification_date, put_plan_start_date, put_finish_date, get_contract_consultant, get_epc_corporation
...
urlpatterns = [
    ...
    path('api/contractInfo/<int:contract_id>/<int:date_id>/',
    ...
    path('api/contractUpdate/<int:contract_id>/',
        put_contract_base_info, name='contractUpdate'),
    path('api/contractConsultants/<int:contract_id>/',
        get_contract_consultant, name='contractConsultants'),
    path('api/contractCorporations/<int:contract_id>/',
        get_epc_corporation, name='contractCorporations'),
    path('api/contractAddendums/contractAddendumList/<int:contract_id>/',
        ContractAddendumAPI.as_view({'get': 'contract_addendum_list'}), 
        name='contractAddendumList'),
]
